...
const analysisOfRequirements = "Determine what needs to be done: what are the inputs, what data needs to be stored, what needs to be output, ..."

const design = "Create a plan to implement the requirements. This can include a flow chart and specifying the languages/technologies to use for each step."
